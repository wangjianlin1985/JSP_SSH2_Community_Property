...
<jsp:include page="check_cwb_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	...
	<div class="logout">您好，<%=session.getAttribute("cwb")%> | <a href="logout.jsp">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_cwb.js"></script>
</body>
</html>
