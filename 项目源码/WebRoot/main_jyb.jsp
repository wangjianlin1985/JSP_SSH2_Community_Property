...
<jsp:include page="check_gyb_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	...
	<div class="logout">您好，<%=session.getAttribute("jyb")%> | <a href="logout.jsp">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_jyb.js"></script>
</body>
</html>
