...
<div id="fee_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="feeQueryForm" method="post">
			...
			<input type="text" class="textbox" id="opUser" name="opUser" value="<%=session.getAttribute("cwb") %>" style="display:none;width:110px" />
...
<script type="text/javascript" src="Fee/js/fee_manage1.js"></script> 
