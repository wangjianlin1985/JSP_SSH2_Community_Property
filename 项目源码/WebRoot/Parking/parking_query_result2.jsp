...
<div id="parking_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="parkingQueryForm" method="post">
			...
			<input type="text" class="textbox" id="opUser" name="opUser" value="<%=session.getAttribute("jyb") %>" style="width:110px" />
...
<script type="text/javascript" src="Parking/js/parking_manage2.js"></script> 
