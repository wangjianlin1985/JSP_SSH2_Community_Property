...
<jsp:include page="check_glb_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	...
	<div class="logout">您好，<%=session.getAttribute("glb")%> | <a href="logout.jsp">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_glb.js"></script>
</body>
</html>
